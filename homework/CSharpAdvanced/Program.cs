...
flowers.Add(rose.Name, numberOfRose);
flowers.Add(chamomile.Name, numberOfChamomile);
...
Console.WriteLine($"Total payable: {FinalCheck(flowers)}");
...
double FinalCheck(Dictionary<string, int> flowers)
{
